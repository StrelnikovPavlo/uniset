 ...
 */
    ...
    (() => {
        ...
        if (inputMasks.length) flsModules.inputmask = Inputmask("+38 (999) 999-99-99", {
        ...
        function initSliders() {
                ...
                const productSlider = new Swiper(slider, {
                    ...
                    on: {
                        slideChange: () => {
                            ...
                            const visibleSlides = slides.filter(((slide, index) => index >= productSlider.activeIndex - 0 && index <= productSlider.activeIndex + 3));
            ...
            if (document.querySelector(".articls__slider")) new Swiper(".articls__slider", {
                modules: [ Pagination, Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1.07,
            ...
            if (document.querySelector(".blogs-slider__body")) new Swiper(".blogs-slider__body", {
                ...
                const comparisonSlider = new Swiper(".comparison__overlay", {
                    ...
                    on: {
                        slideChange: () => {
                            ...
                            const visibleSlides = slides.filter(((slide, index) => index >= comparisonSlider.activeIndex - 0 && index <= comparisonSlider.activeIndex + 2));
                            visibleSlides.forEach((slide => {
                                slide.style.opacity = 1;
                            }));
        ...
        new lazyload_min({
            elements_selector: "[data-bg],[data-srcset]",
...
***************************************************************************** */
        ...
        if (isMobile.any()) {
            ...
            if (buttonCatalog) {
                ...
                document.addEventListener("click", (function(e) {
                    if (catalogList.classList.contains("_show")) if (!catalogList.contains(e.target)) {
        ...
        if (isMobile.any()) {
            ...
            if (buttonBrands) {
                ...
                document.addEventListener("click", (function(e) {
                    if (brandsList.classList.contains("_show")) if (!brandsList.contains(e.target)) {
        ...
        if (cartProduct) cartProduct.forEach((cart => {
            const button = cart.querySelector(".product-cart__buy");
            const originalText = button.textContent;
            button.addEventListener("click", (function() {
                if (button.classList.contains("to-cart")) button.textContent = originalText; else button.textContent = "Товар у корзині";
        ...
        filterCheckbox.forEach((item => {
            item.addEventListener("click", (function() {
                if (!item.classList.contains("_disable")) item.classList.toggle("_selected");
            }));
        }));
        const filterSeries = document.querySelectorAll(".filter-checkbox_button");
        filterSeries.forEach((item => {
            item.addEventListener("click", (function() {
                if (!item.classList.contains("_disable")) item.classList.toggle("_active");
            }));
        }));
        ...
        function updateSimplebarAttribute() {
            ...
            catalogHeaderOverlay.forEach((item => {
                if (isSmallScreen) item.setAttribute("data-simplebar", true); else item.removeAttribute("data-simplebar");
            }));
        }
        ...
        showMoreElements.forEach((showMoreElement => {
            ...
            for (let i = maxParagraphsToShow; i < paragraphs.length; i++) paragraphs[i].classList.add("hidden");
            buttonElement.addEventListener("click", (function() {
                const isContentHidden = paragraphs[maxParagraphsToShow].classList.contains("hidden");
                for (let i = maxParagraphsToShow; i < paragraphs.length; i++) paragraphs[i].classList.toggle("hidden", !isContentHidden);
                const buttonText = isContentHidden ? "Показати менше" : "Детальніше";
                buttonElement.querySelector("span").textContent = buttonText;
                if (!isContentHidden && paragraphs.length <= maxParagraphsToShow) buttonElement.classList.toggle("_showmore-active");
            }));
        }));
        window["FLS"] = true;
        isWebp();
